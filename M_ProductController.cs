...
using ZainUlAbidin.Models;

namespace ZainUlAbidin.Controllers
{
    public class M_ProductController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Product_ID,Product_Name,Product_Description,Product_Picture,Product_SalePrice,Product_PuchasePrice,Product_Category_FID")] M_Product m_Product)
        {
